---
name: skill-catalog
description: A local manager to keep track of and consult installed global skills.
---

# Skill Catalog Manager

This local skill provides awareness and access to the global skills installed on this system. It acts as a bridge to ensure the workspace is always aware of available capabilities.

## Global Skills Directory
`C:\Users\dany_\.agents\skills`
...
Whenever you need details from one of these skills:
1. Reference this `skill-catalog` to find the correct path.
2. Use the `view_file` tool to read the `SKILL.md` located in the global path.
3. Apply the patterns described in the global skill to the current local workspace.
